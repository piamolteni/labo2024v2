#!/usr/bin/env Rscript
cat( "ETAPA  1201_CA_reparar_dataset.r  INIT\n")
...
# Ruta predeterminada si args[1] está vacío o es NA
if (is.na(args[1]) || args[1] == "") {
  args[1] <- "~/labo2024v2"  # Cambia esta ruta predeterminada según sea necesario
}

# Carga el archivo de la librería
source(paste0(args[1], "/src/lib/action_lib.r"))
#------------------------------------------------------------------------------
...
cat( "ETAPA  1201_CA_reparar_dataset.r  START\n")
action_inicializar() 
