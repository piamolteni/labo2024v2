...
PARAM$semilla_primigenia <- 101119
PARAM$qsemillas <- 20
...
for( vcp in c( -0.2, -0.5))
  for (vmax_depth in c(4, 6, 8, 10, 14, 30)) 
    for (vmin_split in c(10, 20, 50, 100, 200, 800))
      for (vmin_bucket in c(2, 6, 8, 16, 32, 20))
      {
